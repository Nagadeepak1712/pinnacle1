...
import { landProjects } from '../data/projects';
import { MapPin, ArrowLeft, CheckCircle2 } from 'lucide-react';

export default function LandProjectDetails() {
  const { id } = useParams();
  const project = landProjects.find(p => p.id === id);
            ...
            <div className="flex flex-col justify-center">
              ...
              <div className="grid grid-cols-2 gap-6 mb-8">
                ...
                <div className="bg-white/40 border border-white/50 rounded-2xl p-4">
                  ...
                  <p className="font-bold text-xl text-brand-dark">Land Development</p>
                </div>
              </div>
